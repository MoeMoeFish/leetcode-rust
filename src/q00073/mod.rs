...
pub(crate) fn demo() {
    ...
    solution2r::Solution::set_zeroes(&mut v.clone());
}
...
mod test {
    ...
    fn inner_test(input: Vec<Vec<i32>>, expected: Vec<Vec<i32>>) {
        ...
        let mut i2r = input.clone();
        solution2r::Solution::set_zeroes(&mut i2r);
        assert_eq!(i2r, expected);
    }
    ...
    fn test3() {
        inner_test(vec![
            ...
            vec![2,3,3,1,0,4,6,5,3,5],vec![5,9,7,3,8,8,5,1,4,3],vec![2,4,7,9,9,8,4,7,3,7],vec![3,5,2,8,8,2,2,4,9,8]], 
